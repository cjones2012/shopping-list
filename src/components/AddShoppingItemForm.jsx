      ...
      <Segment padded='very'>
        ...
        <Form onSubmit={this.props.handleAddShoppingListItemSubmit}>
          ...
          <Form.Field>
            <Grid>
              <Grid.Column width={3}>
                <Button type="button" size="mini" icon="minus" onClick={this.props.onDecreaseQuantity} fluid />
              </Grid.Column>
              <Grid.Column width={3}>
                <Input type="text" size="mini" value={shoppingListItem.quantity} onChange={this.props.onQuantityChange} fluid />
              </Grid.Column>
              <Grid.Column width={3}>
                <Button type="button" size="mini" icon="plus" onClick={this.props.onIncreaseQuantity} fluid />
              </Grid.Column>
            </Grid>
          </Form.Field>
          <Form.Field>
            <Button
              ...
              primary
              fluid
              disabled={!shoppingListItem.name || shoppingListItem.selectedStore <= 0 || shoppingListItem.quantity <= 0}>
              Add
            </Button>
          </Form.Field>
        </Form>
